const PayChallanBank = () => {
  ...
  return (
    <section
      id="pay-challan-bank"
      className="bg-gradient-to-b from-white via-slate-50 to-white py-14 sm:py-16 px-2"
    >
      {/* Heading */}
      <div className="mx-auto mb-10 max-w-3xl space-y-4 px-4 text-center sm:px-6 lg:px-8">
        ...
        <p className="text-lg leading-relaxed text-slate-700 sm:text-base">
      ...
      <div className=" lg:flex gap-3">
        ...
        {/* Payment Steps Card */}
        <div className="flex flex-col gap-4 rounded-2xl  bg-white/90 p-6 shadow-sm shadow-slate-200">
        ...
        <div className="flex flex-col gap-4 rounded-2xl  bg-white/90 p-6 shadow-sm shadow-slate-200">
          ...
          <ul className="grid grid-cols-1 gap-2 text-sm text-slate-800 sm:text-base">
