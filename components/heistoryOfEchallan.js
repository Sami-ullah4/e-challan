      ...
      <div className="mx-auto max-w-4xl space-y-6">
        ...
        <div className="space-y-4 text-slate-700">
          <p className="leading-relaxed">
            ...
            was primarily confined to corporations and commercial entities. Due
            to the lack of technological advancement and digital literacy, most
            citizens were unfamiliar with electronic systems. Government
          ...
          <p className="leading-relaxed">
            ...
            this success, the federal government adopted the system and extended
            its implementation to Sindh, Khyber Pakhtunkhwa (KPK), and
            Balochistan, bringing the entire country under a unified digital
          ...
          <p className="leading-relaxed">
            When the system was finally introduced in Karachi, it became a major
            headline. As Pakistan&apos;s largest and most densely populated city,
            Karachi witnessed a wave of public interest, not only because of the
            improved enforcement but also due to the humorous and unexpected
            snapshots captured by the E-Challan cameras, which quickly became
